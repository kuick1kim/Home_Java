...
=====[숙제] audi.csv bmw.csv cclass.csv 합친후======
  연도별 1990년대 2000년대 2010년대 transmission 변수를 만들고
개수, 평균가격, 중위수 가격, 비율을 표시하는 데이터 만들기
count  mean price   median_price  비율은 비율을 나누면 됨 